        ...
        <div className='w-[350px]'>
            ...
            <form action="" className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <input type="text" placeholder='Enter your password' className='p-2 border border-gray-300 font-roboto rounded-md outline-0' />
                </div>
                ...
                <p className='text-gray-500' onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>Not registered yet?
                    <span className='text-[#013220] cursor-pointer'>Create an account</span>
                    <span>
                        <i className={isHover ? 'fa-solid fa-arrow-up rotate-45 font-extralight text-xs pb-0.5 pr-3 ' : 'fa-solid fa-arrow-up rotate-45 font-extralight text-xs pb-0.5 pr-2 '}></i>
                    </span>
                </p>
            </form>
        </div>
